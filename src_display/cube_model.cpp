...
GLuint CreateCubeMap(){
	...
	glBindTexture(GL_TEXTURE_CUBE_MAP, cubeMap);
		...
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, GL_RGBA8, SKYTEX_SIZE, SKYTEX_SIZE, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_X, 0, GL_RGBA8, SKYTEX_SIZE, SKYTEX_SIZE, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 0, GL_RGBA8, SKYTEX_SIZE, SKYTEX_SIZE, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 0, GL_RGBA8, SKYTEX_SIZE, SKYTEX_SIZE, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Z, 0, GL_RGBA8, SKYTEX_SIZE, SKYTEX_SIZE, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, GL_RGBA8, SKYTEX_SIZE, SKYTEX_SIZE, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0);
